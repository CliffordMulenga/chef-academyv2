  ...
  courses: {
    ...
    cookingCourses: [
      ...
      },
      {
        ...
        courseSchedule:
          "Practical sessions from Monday to Friday in professional kitchens.",
      ...
      },
      {
        ...
        courseSchedule:
          "In-kitchen sessions, combined with theory and religious compliance modules.",
        entryRequirements: [
          "Minimum age: 18",
          "Knowledge of kosher principles preferred",
          "English fluency",
        ],
        description:
      ...
      },
      {
        ...
        courseSchedule:
          "Monday to Friday, hands-on sessions in certified halal kitchens.",
        entryRequirements: [
          "Minimum age: 18",
          "Respect for halal practices",
          "Culinary interest or prior experience",
        ],
        description:
      ...
      },
      {
        ...
        courseSchedule:
          "Includes practical cooking, wine pairing, and ingredient sourcing from Italian suppliers.",
        entryRequirements: [
          "Minimum age: 18",
          "English proficiency",
      ...
      },
      {
        ...
        courseSchedule:
          "Full-day sessions Monday to Friday with pastry labs and sugar art workshops.",
        entryRequirements: [
          "Minimum age: 18",
      ...
      },
      {
        ...
        courseSchedule:
          "Two-week intensive block; 5 days/week in a live kitchen.",
        entryRequirements: ["Minimum age: 18", "English proficiency"],
        description:
      ...
      },
      {
        ...
        entryRequirements: [
          "Minimum age: 18",
          "Prior experience or completion of a basic course",
        ],
        description:
